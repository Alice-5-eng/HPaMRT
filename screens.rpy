...
screen main_menu():
    ...
    imagemap:
        ...
        idle"gui/menu_norm.png"
        hover"gui/menu_hover.png"

        hotspot(40,180,230, 65) action Start()
        hotspot(30, 251, 310, 92) action ShowMenu("load")
        hotspot(30,343,340, 70) action ShowMenu("preferences")
        hotspot(30,425,310, 100) action ShowMenu("about")
        hotspot(20,520, 300, 150) action Quit(confirm=True)
        hotspot(1000, 600, 300, 150) action ShowMenu("help")
